...
- [概要](#概要)
  - [課題: 顔画像登録時のエラーによる離脱](#課題-顔画像登録時のエラーによる離脱)
  - [離脱リスクの試算](#離脱リスクの試算)
- [方法](#方法)
- [処理戦略](#処理戦略)
- [技術調査](#技術調査)
  - [選定基準](#選定基準)
  - [明るさ調整AIモデル](#明るさ調整aiモデル)
  - [顔補正](#顔補正)
  - [顔角度補正](#顔角度補正)
- [モデル選定](#モデル選定)
- [API仕様](#api仕様)
- [アプリを使ってみた](#アプリを使ってみた)
- [アプリにおける課題](#アプリにおける課題)
  - [1. 処理速度による遅延](#1-処理速度による遅延)
  - [2. デバイス認証精度への影響](#2-デバイス認証精度への影響)
- [実装した感想](#実装した感想)
- [今回作成した顔補正API URL](#今回作成した顔補正api-url)
- [参考文献](#参考文献)
...
| 指標 | 数値 |
|------|------|
| バリデーションエラーを経験した送信者 | 47% |
| エラーを経験したユーザーのうち、見積依頼を断念した割合 | 13% |
...
| 加工前 | 加工後 (MST++) |
|--------|----------------|
| ![加工前](images/mst_plus_plus/input.png) | ![MST++出力](images/mst_plus_plus/result.png) |
